...
const Banner = () => {
    return (
        <div className="bg-slate-600 md:flex md:gap-10 p-5 ">
            <div className='md:w-1/2 mt-8'>
                ...
                <div className='flex justify-start gap-5 my-5'>
                    <a href="https://drive.google.com/file/d/1nkoneh8JaBreirI5D04tzrauholPCDTs/view?usp=sharing" target='blank'><button className="btn btn-outline btn-success ">View Resume</button></a>
